	...
	public static void addListeners(final TS3Api api) {
		api.addTS3Listeners(new TS3EventAdapter() {
			...
			public void onTextMessage(TextMessageEvent messageEvent) {
				 ...
				 */
//				if (messageEvent.getMessage().startsWith("!") && Gui.chatCommandsEnabled())
//				{
//					int returnValue = Commands.handle(messageEvent.getMessage(), getApi().getClientInfo(messageEvent.getInvokerId()));
//					
